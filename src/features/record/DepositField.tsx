 ...
 * لا يُنادى `addDeposit` من أيّ ملفٍ في `src/features` غير هذا — بابٌ واحد
 * واستثناءٌ واحد: «سجّل من البنك» يودِع ما وقع في البنك فعلاً، وحارسُه من
 * جنسه — كل سطرٍ يُراجَع بعينه، والمستورَد سابقاً يُعلَّم «موجود» ويُطفأ.
 *
