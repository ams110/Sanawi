...
export const ar = {
  ...
  crypto: {
    ...
    /*
     * اسم الصلاحية حرفياً كما في شاشة بيونكس: «حطّ للقراءة بس» جملةٌ صحيحة
     * لا تدلّ على أي مربّع يُؤشَّر، ومن أشّر غيرها يرجع برسالة رفضٍ لا يفهمها.
     */
    pionexHint: 'في بيونكس: أشّر **Enable reading** بس. ما في صلاحية سحب أصلاً للأفراد.',
    // منصّة أمريكا منفصلة ولا تصدر مفاتيح — قولُها هنا يوفّر بحثاً في حسابٍ لا زرّ فيه.
    pionexUs: 'ملاحظة: Pionex.US (حساب أمريكا) ما بتعطي مفاتيح API نهائياً — بس pionex.com.',
