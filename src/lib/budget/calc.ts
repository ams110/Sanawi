 ...
 *
 * والمعدّل الشهري **جذرٌ هندسيّ** للسنوي لا قسمةً على اثني عشر — توحيداً مع
 * `wealth/freedom.ts` بقرارٍ صريح من صاحب التطبيق (تدقيق آب 2026: ث3).
 * كانت القسمة تُركّب الفائدة اثنتي عشرة مرة فتُخرج أكثر ممّا وُعد به: 7٪
 * تصير 7.23٪ فعلياً، و2,000 شهرياً لعشرين سنة تفترق ~₪26,780 بين الشاشتين
 * عن سؤالٍ واحد. الجذر يعيد بالضبط ما أدخله المستخدم، ولا شيء غيره.
 *
 * والقاعدة مقيَّدة بالصفر كما هناك: عائدٌ أسوأ من −100٪ يجعل الأساس سالباً
 * وجذرَه NaN، والقيد يترجمه إلى ما يعنيه فعلاً — محوُ الرصيد.
 */
export function projectSavings(
  ...
  const monthlyRate = Math.max(0, 1 + finite(annualRatePercent, 7) / 100) ** (1 / 12) - 1
